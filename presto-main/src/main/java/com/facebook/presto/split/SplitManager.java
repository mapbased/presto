...
public class SplitManager
{
    ...
    public PartitionResult getPartitions(TableHandle table, Optional<Map<ColumnHandle, Domain<?>>> domains)
    {
        return getConnectorSplitManager(table).getPartitions(table, domains.or(ImmutableMap.<ColumnHandle, Domain<?>>of()));
    }
