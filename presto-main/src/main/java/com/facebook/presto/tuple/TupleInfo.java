...
/**
 * Tuple layout is for a fixed width value is:
 * <pre>
 *     is_null (byte)
 *     fixed_width_value
 * </pre>
 * <p/>
 * Tuple layout is for a variable width value is:
 * <pre>
 *     is_null (byte)
 *     length (4 bytes)
...
public class TupleInfo
{
    ...
    public boolean equals(int field, Slice slice, int offset, Slice value)
    {
        int size = slice.getInt(offset + SIZE_OF_BYTE);
        return value.equals(0, value.length(), slice, offset, size);
    }
