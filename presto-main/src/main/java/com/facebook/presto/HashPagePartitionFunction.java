...
public class HashPagePartitionFunction
        implements PagePartitionFunction
{
    private final int partition;
    private final int partitionCount;
    private final int partitionedChannel;

    @JsonCreator
    public HashPagePartitionFunction(
            @JsonProperty("partition") int partition,
            @JsonProperty("partitionCount") int partitionCount,
            @JsonProperty("partitionedChannel") int partitionedChannel)
    {
        this.partition = partition;
        this.partitionCount = partitionCount;
        this.partitionedChannel = partitionedChannel;
    }
    ...
    @JsonProperty
    public int getPartitionedChannel()
    {
    ...
    {
        int partitionedHashCode = getPartitionedHashCode(tupleInfos, cursors[partitionedChannel]);
        int bucket = (partitionedHashCode % partitionCount + partitionCount) % partitionCount;
    ...
    private int getPartitionedHashCode(List<TupleInfo> tupleInfos, BlockCursor partitionedCursor)
    {
        ...
        int partitionedLength = tupleInfos.get(partitionedChannel).size(partitionedSlice, partitionedOffset);
    ...
    public int hashCode()
    {
        return Objects.hashCode(partition, partitionCount, partitionedChannel);
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        return Objects.equal(this.partition, other.partition) &&
                ...
                Objects.equal(this.partitionedChannel, other.partitionedChannel);
    }
    ...
    public String toString()
    {
        return Objects.toStringHelper(this)
                ...
                .add("partitionedChannel", partitionedChannel)
                .toString();
    }
