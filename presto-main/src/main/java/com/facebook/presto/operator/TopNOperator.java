...
//            List<TupleReadable> smallestGlobalCandidate = globalCandidates.peek(); // This can be null if globalCandidates is empty
...
//                if (globalCandidates.size() < n || ordering.compare(cursor, smallestGlobalCandidate) > 0) {
