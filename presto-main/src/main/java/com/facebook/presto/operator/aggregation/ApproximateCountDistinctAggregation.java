        ...
        extends SimpleAggregationFunction
{
    ...
    private static final int SLICE_SIZE = Ints.checkedCast(BlockBuilder.DEFAULT_MAX_BLOCK_SIZE.toBytes() / ENTRY_SIZE) * ENTRY_SIZE;
            ...
            extends SimpleGroupedAccumulator
    {
        ...
        protected void processInput(GroupByIdBlock groupIdsBlock, Block valuesBlock)
        {
            ...
            while (newMaxGroupId + 1 > slices.size() * ENTRIES_PER_SLICE) {
                Slice slice = Slices.allocate(SLICE_SIZE);
                slices.add(slice);
            }
