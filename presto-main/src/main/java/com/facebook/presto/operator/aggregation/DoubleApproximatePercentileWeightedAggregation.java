        ...
        implements AggregationFunction
{
    ...
    @Override
    public DoubleApproximatePercentileWeightedGroupedAccumulator createGroupedAggregation(long expectedSize, int[] argumentChannels)
    {
        return new DoubleApproximatePercentileWeightedGroupedAccumulator(expectedSize, argumentChannels[0], argumentChannels[1], argumentChannels[2]);
    }

    @Override
    public GroupedAccumulator createGroupedIntermediateAggregation(long expectedSize)
    {
        return new DoubleApproximatePercentileWeightedGroupedAccumulator(expectedSize, -1);
    }
            ...
            implements GroupedAccumulator
    {
        ...
        public DoubleApproximatePercentileWeightedGroupedAccumulator(long expectedSize, int valueChannel, int weightChannel, int percentileChannel)
        {
        ...
        public DoubleApproximatePercentileWeightedGroupedAccumulator(long expectedSize, int intermediateChannel)
        {
            this.digests = ObjectBigArrays.newBigArray(new DigestAndPercentile[0][], expectedSize);
