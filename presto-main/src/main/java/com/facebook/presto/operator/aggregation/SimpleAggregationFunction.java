        ...
        implements AggregationFunction
{
    ...
    @Override
    public final GroupedAccumulator createGroupedAggregation(long expectedSize, int... argumentChannels)
    {
        ...
        return createGroupedAccumulator(expectedSize, argumentChannels[0]);
    }

    @Override
    public final GroupedAccumulator createGroupedIntermediateAggregation(long expectedSize)
    {
        checkArgument(expectedSize >= 0, "expectedSize is negative");
        return createGroupedAccumulator(expectedSize, -1);
    }

    protected abstract GroupedAccumulator createGroupedAccumulator(long expectedSize, int valueChannel);
