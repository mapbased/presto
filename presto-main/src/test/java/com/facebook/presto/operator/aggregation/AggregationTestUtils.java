...
public final class AggregationTestUtils
{
    ...
    {
        GroupedAccumulator groupedAggregation = function.createGroupedAggregation(0, args);
        for (Page page : pages) {
    ...
    {
        GroupedAccumulator partialAggregation = function.createGroupedAggregation(0, args);
        for (Page page : pages) {
        ...
        GroupedAccumulator finalAggregation = function.createGroupedIntermediateAggregation(1);
    ...
    {
        if (positions == 0) {
            return new GroupByIdBlock(groupId, Slices.EMPTY_SLICE);
        }
        ...
        return new GroupByIdBlock(groupId, blockBuilder.build().getSlice());
    }
