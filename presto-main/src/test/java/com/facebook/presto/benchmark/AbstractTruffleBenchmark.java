 ...
 */
public abstract class AbstractTruffleBenchmark
        extends AbstractBenchmark
{
    ...
    protected AbstractTruffleBenchmark(
    ...
    protected abstract Runnable createRootNode(TaskContext taskContext);

    protected void execute(TaskContext taskContext)
    {
        // todo the loop should be here to simulate the task scheduler
//        while ((Boolean)function.call());
//        function.call(new MyArguments(null));
        createRootNode(taskContext).run();
    }
