...
public class TestMarker
{
    ...
    public void testComparisons()
            throws Exception
    {
        ImmutableList<Marker<Long>> markers = ImmutableList.of(
    ...
    public void testAdjacency()
            throws Exception
    {
        ImmutableMap<Marker<Long>, Integer> markers = ImmutableMap.<Marker<Long>, Integer>builder()
        ...
        for (Map.Entry<Marker<Long>, Integer> entry1 : markers.entrySet()) {
            for (Map.Entry<Marker<Long>, Integer> entry2 : markers.entrySet()) {
